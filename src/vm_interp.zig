...
fn executeVmTest(
    ...
    var feature_set = try allocator.create(sig.core.features.FeatureSet);
    feature_set.* = try utils.createFeatureSet(allocator, instr_context.epoch_context);
...
pub fn createSyscallRegistry(
    allocator: std.mem.Allocator,
    feature_set: *const sig.core.features.FeatureSet,
    is_deploy: bool,
